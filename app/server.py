        ...
        if op == 'AUTH':
            ...
            if op == 'DELETE':
                ...
                if msg['type'] == 'model':
                    ...
                    for param in ['camera_mesh', 'camera_orientation', 'camera_pos', 'camera_size', 'max_velocity', 'photobox_pos', 'photobox_size', 'reach', 'turntable_pos', 'turntable_radius', 'wall_thickness']:
